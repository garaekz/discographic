...
<template>
            ...
            <div class="flex flex-wrap justify-between items-center">
                <div class="flex justify-start items-center">
                    <button data-drawer-target="drawer-navigation" data-drawer-toggle="drawer-navigation"
                        @click="isSidenavOpen = !isSidenavOpen" aria-controls="drawer-navigation"
                    ...
                    <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
                        ...
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Disco</span>
                    </a>
                </div>
                <div class="flex items-center lg:order-2">
                        ...
                        <div>
                            <a href="#"
                                ...
                                <div class="flex-shrink-0">
                                    ...
                                    <div
                                        class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 rounded-full border border-white bg-indigo-700 dark:border-gray-700">
                                ...
                                <div class="pl-3 w-full">
                                    ...
                                    <div class="text-xs font-medium text-indigo-600 dark:text-indigo-500">
                                        a few moments ago
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="#"
                                ...
                                <div class="pl-3 w-full">
                                    <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                                        ...
                                        <span class="font-medium text-indigo-600 dark:text-indigo-500">@bonnie.green</span>
                                        what do you say?
                                    </div>
                                    <div class="text-xs font-medium text-indigo-600 dark:text-indigo-500">
                                        1 hour ago
                    ...
                    <Menu as="div" class="relative inline-block text-left">
                        ...
                        <transition enter-active-class="transition duration-100 ease-out"
                            ...
                            <MenuItems
                                class="absolute right-0 mt-2 w-56 origin-top-right text-base list-none bg-white divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl ring-black ring-opacity-5 focus:outline-none">
                                <div class="py-3 px-4">
                                ...
                                <div class="px-1 py-1">
                                    ...
                                    <form @submit.prevent="logout">
                                        <button type="submit" :class="[
                                            ...
                                            <ArrowLeftOnRectangleIcon :active="active" class="mr-2 h-5 w-5"
                                                aria-hidden="true" />
                                            Sign Out
                                        </button>
                                </form>
    ...
    <!-- Sidebar -->
    <SidebarMenu :open="isSidenavOpen" />

    <header v-if="$slots.header" class="md:ml-64 h-auto pt-16 bg-white dark:bg-gray-800 shadow">
